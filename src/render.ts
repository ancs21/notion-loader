...
// rehype-katex is intentionally NOT included: notion-rehype-k emits `<b>`
// elements without a `properties` object on bold text, which crashes
// rehype-katex's `node.properties.className` access. We don't use math/KaTeX
// in any consumer site; users who need it can pass it via `rehypePlugins`.
